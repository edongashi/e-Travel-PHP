...
if (isset($_POST['prej']) && isset($_POST['deri'])) {
    ...
    if ($_POST['prej'] != "" && $_POST['deri'] != "") {
        $sql = "Select * From udhetimetBus Where Data >= Now() and Prej ='".$_POST['prej']."' and Deri='".$_POST['deri']."'";
    }
    else if ($_POST['prej'] != "" && $_POST['deri'] == "") {
        $sql = "Select * From udhetimetBus Where Data >= Now() and Prej ='".$_POST['prej']."'";
    }
    else if ($_POST['prej'] == "" && $_POST['deri'] != "") {
        $sql = "Select * From udhetimetBus Where Data >= Now() and Deri ='".$_POST['deri']."'";
    }
    else {
        $sql = "Select * From udhetimetBus Where Data >= Now()";
    }
    ...
    <form method="Post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
        <table>
            <tr>
                ...
                <td>
                    <input type="submit" value="Kerko" class='button button-small' style="margin-top: 17px; margin-left: 10px;">
                </td>
            </tr>
        </table>
    </form>
